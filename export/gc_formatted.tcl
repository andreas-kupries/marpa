...
debug define marpa/export/gc-formatted
debug prefix marpa/export/gc-formatted {[debug caller] | }

# # ## ### ##### ######## #############

namespace eval ::marpa::export::gc-formatted {
    namespace export serial container
    namespace ensemble create

    namespace import ::marpa::export::config
    namespace import ::marpa::export::gc::template::get
}

# # ## ### ##### ######## #############
## Public API

proc ::marpa::export::gc-formatted::serial {serial} {
    debug.marpa/export/gc-formatted {}

    lappend map {*}[config]
    lappend map @slif-serial@ \n[Reformat $serial]\n\t

    return [string map $map [get]]
}

proc ::marpa::export::gc-formatted::container {gc} {
    debug.marpa/export/gc-formatted {}
...
proc ::marpa::export::gc-formatted::Reformat {serial {indent {	}} {step {    }}} {
    debug.marpa/export/gc-formatted {}
    set lines {}
...
proc ::marpa::export::gc-formatted::FormatInto {lv serial indent step parent key} {
    upvar 1 $lv lines
...
proc ::marpa::export::gc-formatted::Spec {spec} {
...
proc ::marpa::export::gc-formatted::Indent {script} {
    upvar 1 indent indent step step
    set save $indent
    append indent $step
    uplevel 1 $script
...
proc ::marpa::export::gc-formatted::AddLine {text} {
