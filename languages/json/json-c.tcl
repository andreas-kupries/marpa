...
#* - #Discards:  1
#* - #Always:    1
#* - #Rule Insn: 90 (+2: setup, start-sym)
#* - #Rules:     312 (>= insn, brange)
#* G1
#* - #Symbols:   24
...
critcl::ccode {
    ...
    */
	...
	/* --- (36) --- --- --- Internal
	 */
	 33,  38,  35,  43,  47,  32,  55, 198, 272, 295, 183, 188, 189, 190, 192, 195,
	199, 204, 254, 281, 282, 304,  29,  30,  34,  36,  37,  44,  39,  40,  41,  42,
	 45,  46,  31,  28
    };

    static marpatcl_rtc_sym json_parser_c_l0_rule_definitions [262] = { /* 524 bytes */
	...
	MARPATCL_RCMD_PRIS  (2)     , 311, 283,                  /*                         |   <@BRAN:<\u00c2\u00df>> <@BRAN:<\200\u00bf>> */
	MARPATCL_RCMD_PRIS  (3)     , 224, 310, 283,             /*                         |   <@BYTE:<\u00e0>> <@BRAN:<\u00a0\u00bf>> <@BRAN:<\200\u00bf>> */
	MARPATCL_RCMD_PRIS  (3)     , 312, 283, 283,             /*                         |   <@BRAN:<\u00e1\u00ec>> <@BRAN:<\200\u00bf>> <@BRAN:<\200\u00bf>> */
	MARPATCL_RCMD_PRIS  (3)     , 237, 308, 283,             /*                         |   <@BYTE:<\u00ed>> <@BRAN:<\200\237>> <@BRAN:<\200\u00bf>> */
	MARPATCL_RCMD_PRIS  (3)     , 313, 283, 283,             /*                         |   <@BRAN:<\u00ee\u00ef>> <@BRAN:<\200\u00bf>> <@BRAN:<\200\u00bf>> */
	MARPATCL_RCMD_PRIO  (1), 283, 308,                       /* <@BRAN:<\200\u00bf>>    ::= <@BRAN:<\200\237>> */
	MARPATCL_RCMD_PRIS  (1)     , 310,                       /*                         |   <@BRAN:<\u00a0\u00bf>> */
	...
	MARPATCL_RCMD_BRAN  (308), MARPATCL_RCMD_BOXR (128,159), /* <@BRAN:<\200\237>>      brange (128 - 159) */
	MARPATCL_RCMD_BRAN  (309), MARPATCL_RCMD_BOXR (  9, 10), /* <@BRAN:<\t\n>>          brange (9 - 10) */
	MARPATCL_RCMD_BRAN  (310), MARPATCL_RCMD_BOXR (160,191), /* <@BRAN:<\u00a0\u00bf>>  brange (160 - 191) */
	MARPATCL_RCMD_BRAN  (311), MARPATCL_RCMD_BOXR (194,223), /* <@BRAN:<\u00c2\u00df>>  brange (194 - 223) */
	MARPATCL_RCMD_BRAN  (312), MARPATCL_RCMD_BOXR (225,236), /* <@BRAN:<\u00e1\u00ec>>  brange (225 - 236) */
	MARPATCL_RCMD_BRAN  (313), MARPATCL_RCMD_BOXR (238,239), /* <@BRAN:<\u00ee\u00ef>>  brange (238 - 239) */
