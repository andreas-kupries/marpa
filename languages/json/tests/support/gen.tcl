...
## Enables the dynamic creation of parsers and lexers to test.

## This differs from the copy under <topdir>/tests/support in that it
## expects the marpa packages to be properly installed instead of
## accessing and using them directly.

kt require support marpa::slif::container
kt require support marpa::slif::semantics
kt require support marpa::runtime::tcl
kt require support marpa::runtime::c
kt require support marpa::slif::parser
kt require support marpa::gen
