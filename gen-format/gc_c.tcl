...
# @@ Meta Begin
# Package marpa::gen::format::gc-c 0
# Meta author      {Andreas Kupries}
# Meta category    {Parser/Lexer Generator}
# Meta description Part of TclMarpa. Generator for grammar containers.
# Meta description Human-readable formatting. Reduced as for the C runtime.
...
debug define marpa/gen/format/gc-c
debug prefix marpa/gen/format/gc-c {[debug caller] | }

# # ## ### ##### ######## #############

namespace eval ::marpa::gen::format::gc-c {
...
proc ::marpa::gen::format::gc-c::container {gc} {
    debug.marpa/gen/format/gc-c {}
    marpa::fqn gc

    set gcr [marpa::gen::runtime::c gc [$gc serialize]]
...
proc ::marpa::gen::format::gc-c::Generate {serial} {
    debug.marpa/gen/format/gc-c {}
...
# # ## ### ##### ######## #############
package provide marpa::gen::format::gc-c 0
return
##
